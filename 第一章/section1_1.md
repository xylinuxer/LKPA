<<<<<<< HEAD
## **1.1  从不同角度认识操作系统**
从使用者的角度看，操作系统为用户提供了方便的接口，比如命令接口和图形接口。从程序开发者的角度看，操作系统把软件开发人员从与硬件打交道的繁琐事务中解放出来，比如系统调用接口。从操作系统设计者的角度看，通过对计算机系统中的各种软硬件资源进行有效的管理，以提高系统的性能。简而言之，操作系统的设计目标就是方便用户，提高效率。本书讲围绕这两大方面进行探讨。
...
>>>>>>> bb7c7d6f69d1dc68285a72bb0581599ed6bd235e
